...
const defaultConfig = {
    ...
    labels: {
        ...
        perPage: "{select} resultados por página", // per-page dropdown label
        noRows: "No hay registros por mostrar", // Message shown when there are no records to show
        noResults: "No se encontrol níngun resultado", // Message shown when there are no search results
        info: "Mostrando del registro {start} hasta el {end} de {rows} registros" //
    },
    ...
    render() {
        ...
        if (this.options.paging && this.options.perPageSelect) {
            ...
            const select = createElement("select", {
                class: "dataTable-selector docnav"
            });
        ...
        if (this.options.searchable) {
            const form =
                `<div class='dataTable-search'><input class='dataTable-input topcoat-search-input--large' placeholder='${this.options.labels.placeholder}' type='text'></div>`;
