...
import enum
import sys
from sqlalchemy import Column,ForeignKey,String,Integer, DateTime, Float, Boolean, func
from sqlalchemy.orm import declarative_base,relationship
from sqlalchemy import create_engine
from sqlalchemy.engine import URL
from consad import database_driver
...
class ORMConnection():
    ...
    def __init__(self, config) -> None:
        url_object = None
        if config['DRIVER'] == database_driver.DatabaseType.MARIADB:
        ...
        if config['DRIVER'] == database_driver.DatabaseType.SQLITE:
            url_object = URL.create(
                'sqlite+pysqlite',
...
class Periodo(Base):
    ...
    activo = Column(Boolean, nullable=True, server_default=func.now())

    solicitudes = relationship('Solicitud', cascade='all, delete')

    def __repr__(self) -> str:
        return (f'Periodo(id_periodo={self.id_periodo!r}, descripcion={self.descripcion!r}, '
                 'fechaInicio={self.fecha_inicio!r}, fecha_fin={self.fecha_fin!r}), '
                 'activo={self.activo!r}')
...
class Solicitud(Base):
    ...
    fecharegistro = Column(DateTime, nullable=True, server_default=func.now())
    ...
    def __repr__(self) -> str:
        return (f'Solicitud(id_material={self.id_material!r}, id_zona={self.id_zona!r}, '
                ...
                'cantidad={self.cantidad!r}, fecharegistro={self.fecha_registro!r}, '
